...
import { changeCurrentlyViewedProduct } from '../../Redux/shop/shop.actions';
    ...
    return (
        <div className="shop__item-card">
                <div className="item-card__image">
                    <img src={`http://localhost:8000/${product.image_path}`} alt="Product" />
...
const mapDispatchToProps = dispatch => ({
    changeViewedProduct: (productData) => dispatch(changeCurrentlyViewedProduct(productData))
})
