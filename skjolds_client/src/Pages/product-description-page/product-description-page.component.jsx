                    ...
                    <>
                        ...
                        <div className="item__visual">
                            ...
                            <p className="item__visual--category">
                                {t('Product-description-page.categories')}:
                                {
                                    categoryList
                                }
                            </p>
                        ...
                        <div className="item__information">
                            <div className="item__information--header">
                                ...
                                <p className="information__header--availability">
                                    {t('Product-description-page.availability')}:   
                                        <span>
                                            {t('Product-description-page.in-stock')}
                                        </span>
                                </p>
                            ...
                            <form onSubmit={handleSubmit} onChange={handleChange}>
                                <div className="item__information--item-options">
                                    ...
                                    <div className="item-options__size">
                                        <p>
                                            {t('Product-description-page.size')}
                                        </p>
                                        {
                                            sizeList
                                        }
                                    ...
                                    <div className="item-options__color">
                                        <p>
                                            {t('Product-description-page.color')}
                                        </p>
                                        {
                                            colorList
                                        }
                                    ...
                                    <div className="item-options__quantity">
                                        <p>
                                            {t('Product-description-page.quantity')}
                                        </p>
                                        {
                                ...
                                <div className="item__information--action-btn">
                                    <button type="submit">
                                        ...
                                        <span>
                                            {t('Product-description-page.action-btn')}
                                        </span>
                                    </button>
                                </div>
                            ...
                            <div className="item__information--description">
                                <div className="description__header">
                                    <h3>
                                        {t('Product-description-page.product-description')}
                                    </h3>
                                </div>
                                <p>
                                    {
