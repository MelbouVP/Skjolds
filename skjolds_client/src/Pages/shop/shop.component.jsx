                            ...
                            <form action="">
                                ...
                                <div className="filter-option__color">
                                    ...
                                    <div className="filter-option__color--options">
                                        <label for="gray" className="color__options--gray">
                                            <input type="checkbox" name="color" id="gray" value="gray" />
                                        </label>

                                        <label for="black" className="color__options--black">
                                            <input type="checkbox" name="color" id="black" value="black" />
                                        </label>
                                        
                                        <label for="blue" className="color__options--blue">
                                            <input type="checkbox" name="color" id="blue" value="blue" />
                                        </label>

                                        <label for="yellow" className="color__options--yellow">
                                            <input type="checkbox" name="color" id="yellow" value="yellow" />
                                        </label>

                                        <label for="red" className="color__options--red">
                                            <input type="checkbox" name="color" id="red" value="red" />
                                        </label>

                                        <label for="green" className="color__options--green">
                    ...
                    <div className="shop__container">
                        ...
                        <div className="shop__item-card">
                            ...
                            <div className="item-card__description">
                                ...
                                <a href="/" className="item-card__action-btn">
                                    Browse
                                </a>
                                <p>38.99€</p>
                            </div>
